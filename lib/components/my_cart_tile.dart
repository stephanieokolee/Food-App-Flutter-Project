...
import 'package:flutter_play/components/my_quantity_selector.dart';
      ...
      children: [
        Padding(
          ...
          MyQuantitySelector(
            ...
            food: cartItem.food,
            onDecrement: () {
              restuarant.removeFromCart(cartItem, cartItem.selectedAddons);
            },
            onIncrement: () {
              restuarant.addToCart(cartItem.food, cartItem.selectedAddons);
            })
